...
import static growthcraft.cellar.shared.Reference.FluidColor.WHITE_GRAPE_JUICE_COLOR;
import static growthcraft.cellar.shared.Reference.FluidResource.*;

public abstract class WhiteGrapeJuiceFluid extends ForgeFlowingFluid {

    private static final RegistryObject<FlowingFluidBlock> block = GrowthcraftCellarFluids.WHITE_GRAPE_JUICE_FLUID_BLOCK;
    private static final ColorUtils.GrowthcraftColor color = WHITE_GRAPE_JUICE_COLOR;
