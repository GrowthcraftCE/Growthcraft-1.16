...
public abstract class PurpleGrapeJuiceFluid extends ForgeFlowingFluid {
    ...
    private static final ColorUtils.GrowthcraftColor color = PURPLE_GRAPE_JUICE_COLOR;
    private static final RegistryObject<BucketItem> registry_bucket = GrowthcraftCellarItems.bucket_purple_grape_juice;
