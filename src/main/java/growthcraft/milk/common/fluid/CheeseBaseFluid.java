...
public abstract class CheeseBaseFluid extends ForgeFlowingFluid {

    private static final RegistryObject<FlowingFluidBlock> block = GrowthcraftMilkFluids.CHEESE_BASE_FLUID_BLOCK;
