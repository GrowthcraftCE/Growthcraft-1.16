...
public class GrowthcraftMilkBlockRenders {
    ...
    public static void setRenderLayers() {
        ...
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkFluids.CULTURED_MILK_FLUID_BLOCK.get(), RenderType.getTranslucent());
        ...
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.CHEDDAR_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.APPENZELLER_CHEESE_CURDS.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.APPENZELLER_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.ASIAGO_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.ASIAGO_CHEESE_CURDS.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.EMMENTALER_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.EMMENTALER_CHEESE_CURDS.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.GORGONZOLA_CHEESE.get(), RenderType.getTranslucent());
        ...
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.GOUDA_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.MONTEREY_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.PARMESAN_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.PROVOLONE_CHEESE.get(), RenderType.getTranslucent());
        RenderTypeLookup.setRenderLayer(GrowthcraftMilkBlocks.CASU_MARZU_CHEESE.get(), RenderType.getTranslucent());
