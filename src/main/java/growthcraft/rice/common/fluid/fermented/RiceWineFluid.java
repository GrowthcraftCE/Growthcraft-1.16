...
public abstract class RiceWineFluid extends ForgeFlowingFluid {

    private static final RegistryObject<FlowingFluidBlock> block = GrowthcraftRiceFluids.RICE_WINE_FLUID_BLOCK;
