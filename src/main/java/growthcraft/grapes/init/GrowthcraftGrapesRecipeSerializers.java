...
public class GrowthcraftGrapesRecipeSerializers {
    ...
    public static final IRecipeSerializer<BrewKettleRecipe> GRAPE_VINE_RECIPE_SERIALIZER =
            new BrewKettleRecipeSerializer();

    public static final RegistryObject<IRecipeSerializer<?>> GRAPE_VINE_SERIALIZER = RECIPE_SERIALIZERS.register(
            UnlocalizedName.BREW_KETTLE,
            () -> GRAPE_VINE_RECIPE_SERIALIZER);

    public static final IRecipeType<IBrewKettleRecipe> GRAPE_VINE_RECIPE_TYPE = registerType(IBrewKettleRecipe.RECIPE_TYPE_ID);
